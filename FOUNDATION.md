...
1. **Does not re-prove** existing FCP-DS material (**540** theorems + **34** lemmas in **59** lake roots in [umst-formal-double-slit](https://github.com/tytolabs/umst-formal-double-slit); **574** roots-only; **584** line-start decls incl. all `Lean/*.lean` — counts from upstream `scripts/lean_declaration_stats.py`)
